...
export const SfStablecoinStoreContext = createContext<
    SfStablecoinStore | undefined
>(undefined);
...
export const SfStablecoinStoreProvider: React.FC<
    SfStablecoinStoreProviderProps
> = ({ store, loader, children }) => {
