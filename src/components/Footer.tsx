...
import SecuredFinanceLogo from 'src/assets/icons/secured-finance-logo.svg';
import TwitterIcon from 'src/assets/icons/twitter.svg';

export const Footer = () => {
    return (
        <footer className='border-t-[0.5px] border-[#e3e3e3] px-6 py-7'>
            <div className='flex items-center justify-between gap-4 tablet:flex-col laptop:flex-row'>
                <div className='flex items-center gap-2'>
                    <span className='text-sm text-[#565656]'>Built by</span>
