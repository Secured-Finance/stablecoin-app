export const CardComponent = ({
    ...
    return (
        <div className='flex flex-col rounded-b-xl bg-neutral-50 text-neutral-900 shadow-card'>
            <div className='h-10 border-t-2 border-primary-500 bg-neutral-200 px-3 py-2 text-3.5 font-semibold leading-5.5 tablet:border-t-4 laptop:h-[42px] laptop:px-3.5 laptop:text-base'>
