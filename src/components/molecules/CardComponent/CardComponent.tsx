export const CardComponent = ({
    ...
    return (
        <div className='mt-6 flex flex-col rounded-b-xl bg-neutral-50 drop-shadow-sm'>
            <div className='h-10 border-t-2 border-primary-500 bg-neutral-200 px-3.5 py-2 text-3.5 font-semibold leading-[22px] text-neutral-900 tablet:border-t-4 laptop:h-[42px] laptop:text-base'>
